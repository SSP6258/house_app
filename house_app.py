...
def fn_gen_analysis_statistic(df):
    ...
    for yr in years:
        ...
        #                              barmode='stack', color=colors[years.index(yr)])
        #
        # fig_bar_2 = fn_gen_plotly_hist(fig_bar_2, df_yr['總樓層數'], f'{yr}年', row=1, col=2, bins=50, margin=margin,
        #                              showlegend=True,
        #                              barmode='stack', color=colors[years.index(yr)])
        #
        # fig_bar_2 = fn_gen_plotly_hist(fig_bar_2, df_yr['車位類別'], f'{yr}年', row=2, col=1, bins=50, margin=margin,
        #                              showlegend=False,
        #                              barmode='stack', color=colors[years.index(yr)])
        #
        # fig_bar_2 = fn_gen_plotly_hist(fig_bar_2, df_yr['車位單價(萬)'], f'{yr}年', row=2, col=2, bins=50, margin=margin,
        #                              showlegend=False,
        #                              barmode='stack', color=colors[years.index(yr)])

...
def fn_gen_web_intro():
    st.subheader('這是一個專注於台北市預售屋交易的網站 ')
    st.subheader('內容包含交易紀錄的整理與分析並提供房價預測模型')
    st.write('')
    ...
    with st.expander('📌 機器學習專案流程介紹'):
        st.write('')
        st.write(
            "- 參考自 Medium - Towards Data Science: [Workflow of a Machine Learning project - Ayush Pant](https://towardsdatascience.com/workflow-of-a-machine-learning-project-ec1dba419b94)")

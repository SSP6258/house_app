...
class MultiApp:
    ...
    def run(self):
        ...
        # fn_show_img(dic_of_path['database'], 'house_dora.JPG', is_sidebar=True, width=300, caption="~ by Dora ~")
        fn_show_img(dic_of_path['database'], 'house_dora.jpg', is_sidebar=True, width=None, caption="~ by Dora ~")
